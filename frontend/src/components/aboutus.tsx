  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <section className="mb-8">
        ...
        <p className="text-lg">
          Teemo is an innovative AI-powered platform dedicated to revolutionizing education by providing free,
      ...
      <section className="mb-8">
        ...
        <p className="text-lg">
          At Teemo, we believe that quality education should be accessible to all. That's why our entire solution is
      ...
      <section className="mb-8">
        ...
        <p className="text-lg">
          Teemo's primary aim is to democratize education through the power of artificial intelligence. We strive to:
        </p>
